...
import '../../admin_riverpod/admin_ramayan_notifier.dart';

class AdminRamayan extends ConsumerWidget {
  const AdminRamayan({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final data = ref.watch(adminRamayanNotifierProvider);
    final refRead = ref.watch(adminRamayanNotifierProvider.notifier);
    return Scaffold(
