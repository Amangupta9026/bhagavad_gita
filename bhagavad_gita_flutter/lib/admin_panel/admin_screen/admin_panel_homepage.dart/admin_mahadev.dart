...
import '../../admin_riverpod/admin_mahadev_notifier.dart';

class AdminMahaDev extends ConsumerWidget {
  const AdminMahaDev({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final data = ref.watch(adminmahadevNotifierProvider);
    final refRead = ref.watch(adminmahadevNotifierProvider.notifier);
    return Scaffold(
