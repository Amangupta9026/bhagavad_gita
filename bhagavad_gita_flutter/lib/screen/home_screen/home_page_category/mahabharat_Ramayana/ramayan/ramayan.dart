...
class Ramayana extends StatelessWidget {
  final yt = YoutubeExplode();

  Ramayana({Key? key}) : super(key: key);
                  ...
                  builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
                    ...
                    return Consumer(
                      builder: (context, ref, child) {
                        final refRead =
                            ref.read(ramayanaNotifierProvider.notifier);
