...
Future<void> exportPlaylist(
  ...
  try {
    ...
    log('Error while exporting playlist $e');
    ShowSnackBar().showSnackBar(
      context,
      'Failed Export',
    );
...
Future<List> importFilePlaylist(
  ...
  try {
    ...
    if (temp == '') {
      log('Error while importing playlist, path is empty');
      if (context != null) {
        ShowSnackBar().showSnackBar(
          context,
         'Failed Import',
   ...
   log('Got playlist path $temp');
    ...
    if (context != null) {
      ShowSnackBar().showSnackBar(
        context,
        'Import Success $playlistName',
      );
    }
    return playlistNames;
  } catch (e) {
    log('Error while importing playlist $e');
    if (context != null) {
      ShowSnackBar().showSnackBar(
        context,
        'Failed Import: $e',
