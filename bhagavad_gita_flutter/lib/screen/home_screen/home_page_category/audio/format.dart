...
class FormatResponse {
  ...
  static Future<Map> formatSingleAlbumSongResponse(Map response) async {
    try {
     ...
     log('Error inside FormatSingleAlbumSongResponse: $e');
      return {'Error': e};
    }
  }
  ...
  static Future<Map> formatSingleArtistTopAlbumSongResponse(
    ...
    try {
      ...
      log('Error inside formatSingleArtistTopAlbumSongResponse: $e');
      return {'Error': e};
    }
  }
  ...
  static Future<Map> formatSingleSimilarArtistResponse(Map response) async {
    try {
     ...
     log('Error inside formatSingleSimilarArtistResponse: $e');
      return {'Error': e};
    }
  }
  ...
  static Future<Map> formatSingleShowResponse(Map response) async {
    try {
     ...
     log('Error inside formatSingleShowResponse: $e');
      return {'Error': e};
    }
  }
  ...
  static Future<Map> formatPromoLists(Map data) async {
    try {
     ...
     log('Error inside formatPromoLists: $e');
    }
    return data;
  }
