...
class _DownloadsState extends State<Downloads>
  ...
  void setArtistAlbum() {
    for (final element in _songs) {
      try {
        ...
        log('Error while setting artist and album: $e');
      }
    }
  ...
  Future<void> deleteSong(Map song) async {
    ...
    try {
      ...
      log('Failed to delete $audioFile.path $e');
      ShowSnackBar().showSnackBar(
        context,
        'Failed Delete: ${audioFile.path}\nError: $e',
      );
    }
  }
          ...
          TextButton(
            ...
            onPressed: () async {
              ...
              try {
                ...
                log('Failed to edit tags $e');
                ShowSnackBar().showSnackBar(
                  context,
                  'Failed Tag Edit Error: $e',
                );
              }
            },
            child: Text(
