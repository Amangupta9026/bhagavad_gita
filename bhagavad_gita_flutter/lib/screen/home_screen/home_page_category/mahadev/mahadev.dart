...
class MahaDev extends StatelessWidget {
  final yt = YoutubeExplode();

  MahaDev({Key? key}) : super(key: key);
                  ...
                  builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
                    ...
                    return Consumer(
                      builder: (context, ref, child) {
                        final refRead =
                            ref.read(mahadevNotifierProvider.notifier);
                              ...
                              return Padding(
                                ...
                                child: InkWell(
                                  onTap: () async {
                                    ...
                                    context.pushNamed(RouteNames.mahadevVideo,
                                        pathParameters: {
                                          'title': title,
                                        });
                                    EasyLoading.dismiss();
