...
import 'pod_player_mahadev.dart';

class MahaDevVideo extends StatelessWidget {
  final String? title;
  const MahaDevVideo({super.key, this.title});

  @override
  Widget build(BuildContext context) {
    return Consumer(
      builder: (context, ref, child) {
        final refWatch = ref.watch(mahadevNotifierProvider);
