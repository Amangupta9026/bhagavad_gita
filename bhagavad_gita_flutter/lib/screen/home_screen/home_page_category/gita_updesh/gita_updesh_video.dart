...
import '../../../../riverpod/gita_updesh.dart';
import 'pod_player_gita_updesh.dart';

class GitaUpdeshVideo extends StatelessWidget {
  final String? title;
  const GitaUpdeshVideo({super.key, this.title});

  @override
  Widget build(BuildContext context) {
    return Consumer(
      builder: (context, ref, child) {
        final refWatch = ref.watch(gitaUpdeshNotifierProvider);
        final refRead = ref.read(gitaUpdeshNotifierProvider.notifier);
        return WillPopScope(
          onWillPop: () {
