...
class GitaUpdesh extends StatelessWidget {
  final yt = YoutubeExplode();

  GitaUpdesh({Key? key}) : super(key: key);
                  ...
                  builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
                    ...
                    return Consumer(
                      builder: (context, ref, child) {
                        final refRead =
                            ref.read(gitaUpdeshNotifierProvider.notifier);
                              ...
                              return Padding(
                                ...
                                child: InkWell(
                                  onTap: () async {
                                    ...
                                    context.pushNamed(RouteNames.gitaUpdeshVideo,
                                        pathParameters: {
                                          'title': title,
                                        });
                                    EasyLoading.dismiss();
